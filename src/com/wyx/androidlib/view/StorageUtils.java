...
public final class StorageUtils {
	...
	public static File getCacheDirectory(Context context, boolean preferExternal) {
		...
		if (appCacheDir == null) {
			...
			Log.w("warn", "Can't define system cache directory! '%s' will be used." + cacheDirPath);
	...
	private static File getExternalCacheDir(Context context) {
		...
		if (!appCacheDir.exists()) {
			if (!appCacheDir.mkdirs()) {
				Log.w("warn", "Unable to create external cache directory");
				return null;
			}
			try {
				new File(appCacheDir, ".nomedia").createNewFile();
			} catch (IOException e) {
				Log.w("warn", "Can't create \".nomedia\" file in application external cache directory");
			}
		}
		return appCacheDir;
	}
